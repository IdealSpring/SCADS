...
public class HashMap<K,V> extends AbstractMap<K,V>
     ...
     */
    /**
     * 根据期望容量cap，返回2的n次方形式的 哈希桶的实际容量 length。 返回值一般会大于等于cap
     * 如果cap用二进制表示是10010的形式
     * 那么最终返回的是11111的形式
     */
     ...
     */
    // 将另一个Map的所有元素加入表中，参数evict初始化时为false
     ...
     */
    /**
     * @param onlyIfAbsent 如果是true，不能改变有值的键
    ...
    static final class TreeNode<K,V> extends LinkedHashMap.Entry<K,V> {
        TreeNode<K,V> parent;  // 红黑树父节点 // red-black tree links
        TreeNode<K,V> left;
        TreeNode<K,V> right;
